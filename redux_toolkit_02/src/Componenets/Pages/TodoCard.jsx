...
import { removeTodo, editTodo } from "../../Roots/index";
                ...
                <div className="h-50 w-full rounded-lg bg-white ">
                  <div className="flex items-center justify-between border-b">
                    ...
                    <div className="p-3 flex">
                      ...
                      <button onClick={()=>dispatch(removeTodo(todoObj.id))} className="text-slate-800 hover:text-blue-600 text-sm bg-white hover:bg-slate-100 border border-slate-200 rounded-r-lg font-medium px-4 py-2 inline-flex space-x-1 items-center">
                        <span>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
